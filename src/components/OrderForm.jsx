            ...
            <div className="bg-[#173C21] text-white p-8 md:p-10">
              ...
              <div className="space-y-5">
                <div className="flex gap-4">
                  <div className="text-[#E3A72F] mt-1">
                    <FaWhatsapp />
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-bold">Poulets de qualité</p>
                    <p className="text-sm text-white/60 mt-1">
                      Poulets vivants ou prêts à cuire.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-bold">Yanfolila, Mali</p>
                    <p className="text-sm text-white/60 mt-1">
                      Élevage local.
                    </p>
                  </div>
            ...
            <form onSubmit={handleSubmit} className="p-7 md:p-10">
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label
                    htmlFor="name"
                    className="block text-sm font-bold text-[#173C21] mb-2"
                  >
                    Nom complet *
                  </label>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-[#DED5C4] bg-[#FCFAF5] focus:border-[#E3A72F] focus:ring-2 focus:ring-[#E3A72F]/20 outline-none transition"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.product}
                    onChange={handleChange}
                    className="w-full px-4 py-3.5 rounded-xl border border-[#DED5C4] bg-[#FCFAF5] focus:border-[#E3A72F] focus:ring-2 focus:ring-[#E3A72F]/20 outline-none transition"
                  >
                    <option value="Poulets vivants">
                      Poulets vivants
                    </option>

                    <option value="Poulets prêts à cuire">
              ...
              <div className="mt-5">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    value={form.message}
                    onChange={handleChange}
                    placeholder="Ex : Je souhaite récupérer ma commande le matin..."
                    className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-[#DED5C4] bg-[#FCFAF5] focus:border-[#E3A72F] focus:ring-2 focus:ring-[#E3A72F]/20 outline-none transition resize-none"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full mt-6 inline-flex items-center justify-center gap-3 bg-[#25D366] text-white font-extrabold px-6 py-4 rounded-xl shadow-lg hover:bg-[#20bd5b] hover:-translate-y-0.5 transition-all"
              >
                <FaWhatsapp size={22} />
                Envoyer ma commande sur WhatsApp
              </button>

              <p className="text-center text-xs text-[#6B6255] mt-4">
                Votre commande sera ouverte directement dans WhatsApp.
              </p>
            </form>
          </div>
        </motion.div>
